                ...
                <div className="Header-contener_button">
                    <span>
                        <button
                            ...
                            onClick={() => setIsMenuModalOpen(true)} // Открываем меню-модалку
                        >
                ...
                <div className="Header-contener_grop">
                    <span
                        ...
                        onClick={() => {
                            if (grupName === " не выбрана") {
                                setIsGroupModalOpen(true); // Открываем модалку выбора группы
                            }
                        }}
                        style={{
                    ...
                    <span>
                        {themeType ? (
                            ...
                            >
                                <img src="/moon_stars_24dp_E3E3E3_FILL0_wght400_GRAD0_opsz24.png" alt="Темная тема" />
                            </button>
                        ) : (
                            <button
                                className="Header-contener_grop_button"
